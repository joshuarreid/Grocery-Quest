...
public class BossScreen extends LevelScreen {
    ...
    @Override
    void loadObjects() {
        Label levelLabel = new Label("Boss Level");
        ...
        super.board.addObject(aisle4, "Aisle4", true, 7, 4, 2, 1);
