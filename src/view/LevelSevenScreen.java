...
public class LevelSevenScreen extends LevelScreen {
    public LevelSevenScreen(int width, int height, Player hero, LevelRandomizer lr, Exit[] exits, ArrayList<Monster> monsters) {
        super(width, height, hero, lr, exits, "Level 7", monsters);
    }

    @Override
    void loadObjects() {
        Label levelLabel = new Label("Level 7\n      ");
        levelLabel.setFont(DOGICA_FONT);
        levelLabel.setAlignment(Pos.CENTER);
        super.board.addObject(levelLabel, "Level 7 Label", false, 0, 2, 15, 3);

        //AISLE2
        ImageView aisle2 = new ImageView(new Image("file:resources/pngs/Aisle2.png"));
        aisle2.setFitWidth(60);
        aisle2.setFitHeight(30);
        super.board.addObject(aisle2, "Aisle2", true, 12,1, 8, 2);

        ImageView aisle21 = new ImageView(new Image("file:resources/pngs/Aisle2.png"));
        aisle21.setFitWidth(60);
        aisle21.setFitHeight(30);
        super.board.addObject(aisle21, "Aisle2.1", true, 15, 1, 3, 2);
        ...
        super.board.addObject(aisle5, "Aisle5", true, 7,5, 3, 1);
