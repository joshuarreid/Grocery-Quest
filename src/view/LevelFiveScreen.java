...
public class LevelFiveScreen extends LevelScreen {
    public LevelFiveScreen(int width, int height, Player hero, LevelRandomizer lr, Exit[] exits, ArrayList<Monster> monsters) {
