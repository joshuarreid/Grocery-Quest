...
public class LevelSixScreen extends LevelScreen {
    public LevelSixScreen(int width, int height, Player hero, LevelRandomizer lr, Exit[] exits, ArrayList<Monster> monsters) {
        super(width, height, hero, lr, exits, "Level 6", monsters);
    }
