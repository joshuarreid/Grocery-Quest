...
public class ChallengeScreenSecond extends ChallengeScreen{
    ...
    void loadObjects() {
        ...
        if(loadObj) {
            ...
            ImageView aisle53 = new ImageView(new Image("file:resources/pngs/Aisle5.png"));
            aisle53.setFitWidth(30);
            aisle53.setFitHeight(150);
            super.board.addObject(aisle53, "Aisle5.3", true, 1, 5, 18, 1);
